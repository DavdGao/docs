...
- [Tool](/agentscope/2.0.5dev/en/building-blocks/tool) — the toolkit, the `ToolBase` interface, and how state-injected tools receive `AgentState`.
- [Agent](/agentscope/2.0.5dev/en/building-blocks/agent) — the agent lifecycle, including how `AgentState` is created, restored, and persisted.
