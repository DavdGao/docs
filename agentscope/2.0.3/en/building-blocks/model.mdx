...
In the agent layer, TTS is integrated via [`TTSMiddleware`](/agentscope/2.0.3/en/building-blocks/middleware#ttsmiddleware) — it intercepts the agent's text output and synthesizes speech automatically:
