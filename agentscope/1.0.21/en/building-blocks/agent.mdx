---
title: "Agent"
description: "A guide to using built-in agents in AgentScope, including ReActAgent, hooks, state management, A2A, and realtime agents."
icon: "robot"
---
...
<CardGroup cols={3}>
  ...
  <Card title="State and Session Management" icon="database" href="#state-and-session-management">
...
| Automatic state management | See [State and Session Management](#state-and-session-management) |
