---
title: 'Deep Research'
description: 'Deep Research agent for information collection and report generation.'
icon: 'brain'
---
...
<Frame>
  <img src="../images/dragent_workflow.png" alt="DeepResearch Agent workflow diagram" />
</Frame>
