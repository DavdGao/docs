---
title: 'Data Science'
description: 'Data Science agent for end-to-end data analysis and modeling workflows.'
icon: 'chart-line'
---
...
<Frame>
  <img src="../images/alias/alias-ds-overall.png" alt="Data Science Agent overall workflow" />
</Frame>
