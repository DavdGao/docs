...
description: 'Building a multi-agent customer support system using AgentScope'
icon: 'users'
---
...
- [**Hooking Functions**](/agentscope/1.0.21/en/building-blocks/hooking-functions) — Detailed usage of agent hooks, including Human-in-the-Loop patterns
- [**Orchestration**](/agentscope/1.0.21/en/building-blocks/orchestration) — In-depth guide to routing strategies, MsgHub, and Orchestrator-Workers patterns
