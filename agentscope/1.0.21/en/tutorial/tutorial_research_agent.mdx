...
description: 'Building a personal research assistant with AgentScope.'
...
- [**Context and Memory**](/agentscope/1.0.21/en/building-blocks/context-and-memory) — Complete guide to short-term and long-term memory
- [**Tool Capabilities**](/agentscope/1.0.21/en/building-blocks/tool-capabilities) — Complete guide to tools and function calling
- [**Agent**](/agentscope/1.0.21/en/basic-concepts/agent) — Agent customization and advanced features
