---
title: 'Prompt Tuning'
description: 'Optimize agent system prompts using prompt optimization techniques'
icon: 'comment-dots'
---
...
Continuing from [Overview](/agentscope/1.0.21/en/tune-agent/tune-your-first-agent#workflow-function), assume you have a task dataset and judge function ready. Now, refine your workflow function for prompt tuning:
