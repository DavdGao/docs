...
<CardGroup cols={1}>
	<Card title="ReAct Agent" icon="robot" href="/agentscope/2.0.4/en/building-blocks/agent" cta="Get Started">
	...
	<Card title="Toolkit" icon="toolbox" href="/agentscope/2.0.4/en/building-blocks/tool" cta="Learn about toolkit">
		Agent self-managed tool system with Python functions, MCP and skills integration.
	</Card>
	<Card title="Context" icon="memory" href="/agentscope/2.0.4/en/building-blocks/context" cta="View context">
	...
	<Card title="Sandbox Isolation" icon="codepen" href="/agentscope/2.0.4/en/building-blocks/workspace" cta="Learn about sandbox">
	...
	<Card title="Agent as Service" icon="server" href="/agentscope/2.0.4/en/deploy/agent-service" cta="Learn about agent service">
