...
<CardGroup cols={2}>
  <Card title="Permission System" href="/agentscope/2.0.4/en/building-blocks/permission-system">
    Control which tools the agent can call and under what conditions.
  </Card>
  <Card title="Middleware" href="/agentscope/2.0.4/en/building-blocks/middleware">
