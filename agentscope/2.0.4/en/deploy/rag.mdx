...
<CardGroup cols={2}>
  <Card title="RAG" icon="cubes" href="/agentscope/2.0.4/en/building-blocks/rag" cta="View library-mode usage" arrow>
    Learn the atomic interfaces of parser / chunker / vector store / middleware and their library-mode usage.
  </Card>
  <Card title="Architecture" icon="sitemap" href="/agentscope/2.0.4/en/deploy/agent-service" cta="View create_app parameters" arrow>
