...
After choosing and starting a service interface, see the [service-based agent integration guide](/reme/latest/en/integration/plugins) for tool, plugin, and Skill patterns.
