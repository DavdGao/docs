...
After choosing and starting a service interface, see [Agents](/reme/latest/en/integration/agents) for tool, plugin, and Skill patterns that let an Agent use the service.
