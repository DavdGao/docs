...
- Compare the available [integration paths](/reme/latest/en/integration/overview), then use the [Python SDK](/reme/latest/en/integration/python-sdk) or install a [plugin](/reme/latest/en/integration/plugins).
