...
- 先在[集成概览](/reme/latest/zh/integration/overview)中比较不同方式；宿主进程可以选择 [Python SDK](/reme/latest/zh/integration/python-sdk)，也可以安装[插件](/reme/latest/zh/integration/plugins)。
