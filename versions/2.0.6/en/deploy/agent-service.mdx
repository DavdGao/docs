...
|------------|-------------|
| Agent teams | A leader agent spawns worker agents and coordinates them through built-in team tools; see the [Agent Team](/versions/2.0.6/en/deploy/agent-team) chapter. |
...
<CardGroup cols={2}>
  <Card title="Agent" icon="robot" href="/versions/2.0.6/en/building-blocks/agent/overview">
    Core agent abstraction and the ReAct loop
  </Card>
  <Card title="Message & Event" icon="envelope" href="/versions/2.0.6/en/building-blocks/message-and-event">
  ...
  <Card title="Context" icon="database" href="/versions/2.0.6/en/building-blocks/context/overview">
