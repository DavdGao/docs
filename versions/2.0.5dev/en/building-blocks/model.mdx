...
In the agent layer, TTS is integrated via [`TTSMiddleware`](/versions/2.0.5dev/en/building-blocks/middleware#ttsmiddleware) — it intercepts the agent's text output and synthesizes speech automatically:
