...
| `structured_output` | `dict \| None`                | The validated structured result when the reply required a [structured schema](/versions/2.0.5dev/en/building-blocks/agent/run-agent#structured-output); set by the agent on the final message |
...
<CardGroup cols={2}>
  ...
  <Card title="Context" icon="database" href="/versions/2.0.5dev/en/building-blocks/context/overview">
