...
For the sandboxed backends (Docker, E2B, Daytona, K8s, OpenSandbox), MCP servers run *inside* the isolated environment; the host reaches them through an in-workspace gateway, covered in [MCP Gateway](/versions/2.0.5/en/building-blocks/workspace/mcp-gateway).
