...
| `structured_output` | `dict \| None`                | The validated structured result when the reply required a [structured schema](/versions/2.0.5/en/building-blocks/agent/run-agent#structured-output); set by the agent on the final message |
