...
Pass any object satisfying this protocol to the agent's `offloader` argument. Every built-in [workspace](/versions/2.0.7/en/building-blocks/workspace/overview) (local, Docker, E2B, ...) implements the protocol and can serve as the offloader directly:
