...
<Tip>
For an in-depth look at what a workspace *is* (filesystem layout, gateway, MCP wiring, builtin tools), see the [Workspace](/versions/2.0.7/en/building-blocks/workspace/overview) building-block chapter.
</Tip>
