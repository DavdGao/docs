---
title: "中断智能体"
description: "干净地停止运行中或暂停中的智能体，并从一致状态恢复"
---
...
<Note>
使用 `agent.state.reply_id` 引用当前处于暂停状态的回复。有关智能体如何进入暂停状态，请参见[人机交互](/versions/2.0.7dev/zh/building-blocks/agent/human-in-the-loop)。
</Note>
