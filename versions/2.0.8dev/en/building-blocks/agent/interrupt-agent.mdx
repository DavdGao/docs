...
<Note>
Use `agent.state.reply_id` to reference the reply that is currently paused. See [Human-in-the-Loop](/versions/2.0.8dev/en/building-blocks/agent/human-in-the-loop) for how the agent enters a paused state.
</Note>
