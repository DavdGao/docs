...
- [大语言模型](/versions/2.0.8dev/zh/building-blocks/model/llm)：驱动智能体的对话与工具调用
- [语音合成](/versions/2.0.8dev/zh/building-blocks/model/tts)：将文本转换为合成语音音频
- [嵌入模型](/versions/2.0.8dev/zh/building-blocks/model/embedding)：将文本与多媒体内容转换为稠密向量
