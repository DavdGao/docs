---
title: "卸载上下文"
description: "持久化被移除的内容，供智能体按需回查"
---
...
把实现该协议的对象传入智能体的 `offloader` 参数即可完成挂载。所有内置[工作区](/versions/2.0.6dev/zh/building-blocks/workspace/overview)（本地、Docker、E2B 等）都实现了该协议，可以直接用作卸载器：
